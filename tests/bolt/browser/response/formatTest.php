...
class formatTest extends Test {
    ...
    public function test_construct() {
        $this->assertTrue(in_array('bolt\browser\response\format\face', class_implements($this->f)));
...
class formatTest_Class extends bolt\browser\response\format {
...
class formatTest_ClassFormat extends bolt\browser\response\format {

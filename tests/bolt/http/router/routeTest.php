...
class router_routeTest extends Test {
    ...
    public function test_inherits() {
        $r = new route('path');
        $this->assertTrue(in_array('bolt\http\router\face', class_implements($r)));
    ...
    public function test_staticCreate() {
        ...
        $this->assertInstanceOf('bolt\http\router\route', $r);
    ...
    public function test_setGetControllerCallback() {
        ...
        $this->eq('\bolt\http\controller\closure', $r->getController());
        $d = $r->getDefaults();
